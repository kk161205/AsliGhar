...
SYSTEM_PROMPT = (
    ...
    "The listing being checked is described under `submitted_listing`; state its "
    "rent and city only from there — other figures in the evidence belong to the "
    "sources they are listed under, never to the submitted listing. "
    ...
    "Anything marked \"indicator\" (in signals, evidence or insights) is worth "
    "checking but is not proof: word it with \"may\" or \"worth checking\". Only "
    "items marked \"proven\" may be stated as fact. Mention at most the two most "
    "important insights. "
